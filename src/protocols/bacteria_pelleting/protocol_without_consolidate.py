...
from transcriptic_tools.utils import (ul, ml, get_cell_line_name, get_well_max_volume,
                                      ...
                                      round_volume, get_well_safe_volume, init_inventory_well)
...
from transcriptic_tools.custom_protocol import DEFAULT_TRASH_PLATE_SIZE
...
def pellet_bacteria(p, source_bacteria_well,
    ...
    p.trash_plate_size = '96-deep'
    
    init_inventory_well(source_bacteria_well)
    ...
    # Tubes and plates
    growth_plate = p.ref('growth_plate', cont_type="96-deep", discard=False, storage=Temperature.cold_80)
    ...
    p.incubate(growth_plate, "warm_37", "{}:hour".format(24), shaking=True)
    ...
    if induce_high_copy_number:
        ...
        p.trash_max_volume(growth_plate, sterile=False)
